...
import Form_modal from "@/custom_components/form_modal/buy_pdf_form";
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_DOMAIN}courses/get_pdf_notes_details.php?study_notes_meta=${params.buy_course}
          `
      );
