...
export default function BuyCourse({ params }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_DOMAIN}courses/get_study_notes_details.php?study_notes_meta=${params.buy_course}
          `
      );
          ...
          <div className="ml-4  container sm:mx-auto section">
            <div className=" grid grid-cols-12   justify-items-start   -mt-[24rem] md:-mt-[26rem] mb-24 ">
              <div className="z-20 md:col-span-5  col-span-5 justify-self-start  ">
                <div>
                  <div className="card-hover-effect card card-compact max-w-96 w-[18rem] xs:w-[39rem] sm:w-[22rem]  md:w-[21.5rem] p-4  bg-[#FFFEF7] shadow-xl border-white border-4 ">
