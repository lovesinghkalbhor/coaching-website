...
export default function BuyCourse() {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `${process.env.NEXT_PUBLIC_DOMAIN}courses/get_all_study_notes.php?medium=${language}`
  ...
  return (
    <div>
      {" "}
      <Hero_other_pages>
        <div className=" flex flex-wrap md:justify-start justify-center content-center  ">
      ...
      <div className="section container relative overflow-hidden mx-auto ">
        ...
        <div>
          <div className="flex justify-between">
            ...
            <div className="h-10 flex space-x-6 static">
              <h5
                className={clsx(
                  // Base class
